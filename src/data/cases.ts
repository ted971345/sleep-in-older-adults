...
const sleepClues = (
  ...
  clue(`${prefix}-clue-osa`, "Obstructive sleep apnea", osaIds, "Obstructive sleep apnea (OSA) clues include loud snoring, witnessed apneas, gasping, morning headache, hypertension, obesity, and excessive sleepiness."),
  clue(`${prefix}-clue-rls`, "Restless legs syndrome", rlsIds, "Restless legs syndrome (RLS) requires an urge to move the legs that worsens at rest or evening and is relieved by movement; mimics include cramps, neuropathy, edema, arthritis, and positional discomfort."),
...
export const cases: SleepCase[] = [
  makeCase({
    ...
    reasoningPathways: ["Normal aging with advanced sleep timing and lighter sleep", "Chronic insomnia if distress, impairment, and maladaptive sleep behaviors dominate", "obstructive sleep apnea (OSA) or medication-related risk if snoring, witnessed apneas, sedatives, or functional decline emerge"],
    ...
    educationalFeedback: ["The key move is not dismissing the concern as aging, but showing that red-flag screening was negative.", "Graduate learners should separate normal sleep timing shifts from insomnia disorder, obstructive sleep apnea (OSA), restless legs syndrome (RLS), medication effects, and depression."],
    ...
    followUp: {
      ...
      options: [
        ...
        option("normal-ask-breathing", "Ask about snoring, gasping, witnessed apneas, and morning headaches.", "A brief obstructive sleep apnea (OSA) screen prevents premature reassurance.", ["normal-breathing"]),
        option("normal-ask-medications", "Review prescription, over-the-counter (OTC), and supplement use for sleep or allergies.", "Medication effects are common, modifiable, and often missed.", ["normal-medications"]),
    ...
    redFlagStep: {
      ...
      options: [
        ...
        option("normal-flag-sedatives", "Regular anticholinergic sleep aid use.", "This would be important, but she is not using over-the-counter (OTC) PM sleep-aid products."),
      ],
    },
    prioritization: {
    ...
    recommendations: {
      ...
      options: [
        ...
        option("normal-rec-avoid-pm", "Avoid diphenhydramine or other over-the-counter (OTC) PM sleep aids.", "Anticholinergic sleep aids add risk without a clear indication here."),
    ...
    formativeFeedback: {
      domains: [
        ...
        domain("red-flag-recognition", "Red Flag Recognition", ["normal-ask-breathing", "normal-ask-medications", "normal-ask-mood", "normal-flag-none"], "You checked the major risks before reassuring.", "Before reassuring, screen for obstructive sleep apnea (OSA) symptoms, medication risk, mood/cognition, and safety."),
        ...
        domain("recommendation-quality", "Recommendation Quality", ["normal-rec-education", "normal-rec-light", "normal-rec-monitor", "normal-rec-avoid-pm"], "Your recommendations were conservative, practical, and safety-aware.", "Teach normal changes, preserve routines, and avoid over-the-counter (OTC) PM sleep-aid products."),
  ...
  makeCase({
    ...
    learningObjectives: [
      ...
      { id: "insomnia-lo-plan", text: "Prioritize cognitive behavioral therapy for insomnia (CBT-I) elements, safety, and comorbidity review over sedative escalation." },
    ],
    reasoningPathways: ["Chronic insomnia disorder with conditioned arousal and compensatory naps", "obstructive sleep apnea (OSA) if snoring, apneas, or prominent sleepiness are revealed", "Depression or complicated grief if mood symptoms dominate", "Medication-related insomnia if stimulants or activating medications are mistimed"],
    ...
    recommendedPriorities: ["Confirm chronic insomnia criteria and contributors", "Screen depression, suicide risk, obstructive sleep apnea (OSA), medications, and substances", "Begin cognitive behavioral therapy for insomnia (CBT-I)-oriented behavioral plan and sleep diary", "Avoid benzodiazepines and over-the-counter (OTC) anticholinergic sleep aids"],
    ...
    followUp: {
      ...
      options: [
        ...
        option("insomnia-ask-breathing", "Ask about snoring, apneas, gasping, and morning headaches.", "Obstructive sleep apnea (OSA) can masquerade as insomnia, especially with repeated awakenings.", ["insomnia-breathing"]),
        option("insomnia-ask-goals", "Ask what treatment outcomes and tradeoffs matter most.", "Preferences shape whether the plan begins with cognitive behavioral therapy for insomnia (CBT-I), medication discussion, or stepped care.", ["insomnia-goals"]),
        option("insomnia-ask-psg", "Schedule polysomnography before completing a behavioral sleep history.", "Sleep testing is not routine for uncomplicated chronic insomnia without obstructive sleep apnea (OSA) or movement-disorder clues."),
      ],
    },
    classification: {
      ...
      options: [
        ...
        option("insomnia-class-osa", "Probable obstructive sleep apnea.", "Obstructive sleep apnea (OSA) remains worth screening for, but breathing and sleepiness clues are not dominant here."),
    ...
    redFlagStep: {
      ...
      options: [
        ...
        option("insomnia-flag-apneas", "Witnessed apneas.", "This would raise concern for obstructive sleep apnea (OSA), but it is not present."),
    ...
    recommendations: {
      ...
      options: [
        ...
        option("insomnia-rec-cbti", "Refer for cognitive behavioral therapy for insomnia (CBT-I) or deliver structured CBT-I components if access is limited.", "Behavioral and psychological treatment is foundational for chronic insomnia."),
        ...
        option("insomnia-rec-diphenhydramine", "Recommend nightly diphenhydramine because it is available over the counter.", "Over-the-counter (OTC) availability does not make anticholinergic sleep aids safe for older adults."),
      ],
    },
    ...
    formativeFeedback: {
      domains: [
        ...
        domain("red-flag-recognition", "Red Flag Recognition", ["insomnia-ask-mood", "insomnia-ask-breathing", "insomnia-flag-mood"], "You screened for mood safety and obstructive sleep apnea (OSA) before focusing on insomnia care.", "Do not skip mood, self-harm, substance, obstructive sleep apnea (OSA), and safety screens."),
        domain("prioritization", "Prioritization", ["insomnia-priority-confirm", "insomnia-priority-cbti", "insomnia-priority-med-safety"], "Your priorities support diagnosis first, behavioral treatment second, medication caution throughout.", "Prioritize cognitive behavioral therapy for insomnia (CBT-I) mechanisms before medication escalation."),
        domain("recommendation-quality", "Recommendation Quality", ["insomnia-rec-diary", "insomnia-rec-cbti", "insomnia-rec-caffeine", "insomnia-rec-med-caution"], "Your recommendations target mechanisms and age-related medication risk.", "Include sleep diary, cognitive behavioral therapy for insomnia (CBT-I) components, stimulant timing, and medication caution."),
  ...
  makeCase({
    ...
    summary: "Recognize obstructive sleep apnea (OSA) risk in an older adult and prioritize diagnostic testing while addressing safety.",
    ...
    learningObjectives: [
      { id: "osa-lo-risk", text: "Identify obstructive sleep apnea (OSA) risk features in an older adult with cardiometabolic comorbidity." },
      { id: "osa-lo-testing", text: "Choose diagnostic testing and safety counseling appropriate to complexity and comorbidity." },
    ],
    reasoningPathways: ["Probable obstructive sleep apnea (OSA) with loud snoring, witnessed apneas, sleepiness, morning headaches, and hypertension", "Insomnia if awakenings and worry dominate without breathing clues", "Medication or alcohol-related sedation if respiratory depressants are present", "Multifactorial geriatric sleep problem because cognition, driving, and cardiovascular risk interact"],
    redFlags: ["Witnessed apneas", "Drowsy driving", "Cardiovascular comorbidity", "Morning headaches and sleepiness"],
    recommendedPriorities: ["Address drowsy driving and safety immediately", "Assess obstructive sleep apnea (OSA) risk and arrange sleep testing", "Review medications and alcohol that worsen sleep-disordered breathing", "Coordinate cardiometabolic risk follow-up"],
    educationalFeedback: ["Obstructive sleep apnea (OSA) can present as fatigue, cognitive change, resistant hypertension, morning headache, and falls risk in older adults.", "The testing choice should reflect comorbidity and clinical complexity."],
    ...
    information: [
      ...
      { id: "osa-history", label: "Clinical Context", category: "history", detail: "Body mass index (BMI) is 34. Blood pressure requires three agents, and atrial fibrillation is rate controlled." },
    ...
    followUp: {
      ...
      options: [
        option("osa-ask-breathing", "Ask about snoring, witnessed apneas, gasping, and sleep position.", "These are central obstructive sleep apnea (OSA) probability clues.", ["osa-breathing"]),
        ...
        option("osa-ask-insomnia", "Clarify whether awakenings are prolonged and worry-driven.", "This helps separate obstructive sleep apnea (OSA)-related awakenings from primary insomnia.", ["osa-insomnia"]),
    ...
    redFlagStep: {
      ...
      options: [
        ...
        option("osa-flag-cv", "Atrial fibrillation and resistant hypertension.", "Cardiovascular comorbidity raises the stakes of untreated obstructive sleep apnea (OSA)."),
    ...
    recommendations: {
      ...
      options: [
        ...
        option("osa-rec-sedatives", "Avoid sedatives and review alcohol because they can worsen breathing and alertness.", "Sedation can compound obstructive sleep apnea (OSA) and falls risk."),
        option("osa-rec-follow-up", "Plan follow-up for results, positive airway pressure (PAP) readiness, and cardiometabolic coordination.", "Testing is only useful if results lead to a feasible treatment plan."),
    ...
    feedbackSummary: "This case centers on recognizing a high-risk obstructive sleep apnea (OSA) cluster and acting on safety before reassurance or insomnia treatment.",
    formativeFeedback: {
      domains: [
        domain("problem-representation", "Problem Representation", ["osa-ask-breathing", "osa-ask-sleepiness", "osa-class-probable"], "You represented the case as probable obstructive sleep apnea (OSA) with safety and cardiometabolic relevance.", "Link snoring, apneas, sleepiness, morning headache, obesity, and hypertension into the problem statement."),
        domain("red-flag-recognition", "Red Flag Recognition", ["osa-flag-apneas", "osa-flag-driving", "osa-flag-cv", "osa-flag-cognition"], "You recognized the major obstructive sleep apnea (OSA) danger signals.", "Do not miss witnessed apneas, drowsy driving, cardiovascular disease, and mentation change."),
        ...
        domain("recommendation-quality", "Recommendation Quality", ["osa-rec-testing", "osa-rec-driving", "osa-rec-sedatives", "osa-rec-follow-up"], "Your recommendations are aligned with suspected obstructive sleep apnea (OSA) and older-adult risk.", "A strong plan includes testing, driving safety, sedative avoidance, and follow-up."),
        domain("age-friendly-framing", "Age-Friendly Framing", ["osa-ask-comorbid", "osa-ask-sleepiness", "osa-rec-driving", "osa-rec-follow-up"], "You framed obstructive sleep apnea (OSA) through function, mentation, mobility, and what matters.", "Tie obstructive sleep apnea (OSA) to driving, cognition, and patient goals."),
      ],
  ...
  makeCase({
    ...
    summary: "Use symptom timing and relief pattern to distinguish restless legs syndrome (RLS) from cramps, neuropathy, insomnia, and medication effects.",
    ...
    learningObjectives: [
      { id: "rls-lo-criteria", text: "Apply core restless legs syndrome (RLS) symptom criteria and distinguish common mimics." },
      { id: "rls-lo-iron", text: "Prioritize iron studies and exacerbating-factor review before medication selection." },
    ],
    reasoningPathways: ["restless legs syndrome (RLS) if urge to move, rest worsening, evening predominance, and relief with movement are present", "Nocturnal leg cramps if painful focal muscle tightening dominates", "Neuropathy if symptoms are constant and not relieved by movement", "Medication-exacerbated restless legs syndrome (RLS) if antihistaminergic or serotonergic drugs are present"],
    redFlags: ["Symptoms causing severe sleep loss", "Chronic kidney disease (CKD) and possible iron deficiency", "Sedating antihistamine use that may worsen symptoms and cognition"],
    recommendedPriorities: ["Confirm restless legs syndrome (RLS) criteria and exclude mimics", "Check ferritin and transferrin saturation", "Address exacerbating medications and caffeine/alcohol", "Discuss evidence-based therapy if symptoms persist"],
    educationalFeedback: ["Restless legs syndrome (RLS) diagnosis is clinical and pattern-based; learners should not equate all leg discomfort with RLS.", "Iron assessment and exacerbating-factor review are essential first moves."],
    ...
    information: [
      ...
      { id: "rls-history", label: "Clinical Context", category: "history", detail: "She has chronic kidney disease (CKD) stage 3a and was treated for iron deficiency anemia several years ago." },
    ...
    followUp: {
      ...
      options: [
        option("rls-ask-criteria", "Ask whether symptoms worsen at rest or evening and improve with movement.", "These features define the restless legs syndrome (RLS) reasoning pathway.", ["rls-criteria"]),
        option("rls-ask-mimics", "Ask about cramps, neuropathy, edema, arthritis, and positional discomfort.", "Restless legs syndrome (RLS) mimics are common and change management.", ["rls-mimics"]),
        ...
        option("rls-ask-iron", "Ask about iron deficiency, kidney disease, and recent labs.", "Iron status strongly influences restless legs syndrome (RLS) treatment decisions.", ["rls-history", "rls-goals"]),
        option("rls-ask-breathing", "Screen for snoring, apneas, and drowsy driving.", "Obstructive sleep apnea (OSA) can coexist and should not be ignored, though it is less likely here.", ["rls-breathing"]),
        option("rls-ask-tracker", "Ask for consumer sleep-stage percentages.", "Tracker staging is not needed to establish restless legs syndrome (RLS) criteria."),
      ],
    },
    classification: {
    ...
    redFlagStep: {
      ...
      options: [
        option("rls-flag-iron", "History of iron deficiency.", "Iron studies are a core part of clinically significant restless legs syndrome (RLS) evaluation."),
        option("rls-flag-meds", "Diphenhydramine and serotonergic medication exposure.", "Some medications can exacerbate restless legs syndrome (RLS) and add geriatric safety risk."),
        option("rls-flag-ckd", "Chronic kidney disease (CKD).", "Chronic kidney disease (CKD) increases restless legs syndrome (RLS) relevance and affects medication choice."),
    ...
    prioritization: {
      ...
      options: [
        option("rls-priority-confirm", "Confirm restless legs syndrome (RLS) criteria and exclude common mimics.", "Clinical pattern comes before treatment."),
    ...
    recommendations: {
      ...
      options: [
        option("rls-rec-iron", "Check morning iron studies, including ferritin and transferrin saturation.", "Guideline-based restless legs syndrome (RLS) care begins with iron assessment when symptoms are clinically significant."),
        ...
        option("rls-rec-mimics", "Document why cramps, neuropathy, edema, and arthritis are less likely.", "Restless legs syndrome (RLS) diagnosis is stronger when mimics are explicitly considered."),
    ...
    feedbackSummary: "This case emphasizes pattern recognition and treatment restraint: confirm restless legs syndrome (RLS), check iron, remove exacerbators, and select therapy with older-adult safety in mind.",
    formativeFeedback: {
      domains: [
        domain("problem-representation", "Problem Representation", ["rls-ask-criteria", "rls-ask-mimics", "rls-class-probable"], "You represented the case as probable restless legs syndrome (RLS) while checking mimics.", "Use the restless legs syndrome (RLS) criteria explicitly: rest, evening, movement relief, and exclusion of mimics."),
        domain("red-flag-recognition", "Red Flag Recognition", ["rls-flag-iron", "rls-flag-meds", "rls-flag-ckd"], "You recognized the major contributors that change evaluation and treatment.", "Do not miss iron deficiency, chronic kidney disease (CKD), and exacerbating medications."),
        domain("prioritization", "Prioritization", ["rls-priority-confirm", "rls-priority-iron", "rls-priority-exacerbators"], "Your priorities match guideline-consistent restless legs syndrome (RLS) care.", "Confirm the pattern and check iron before jumping to chronic medication."),
  ...
  makeCase({
    ...
    title: "Over-the-Counter Sleep Aid Medication and Next-Day Risk",
    teaser: "An 82-year-old uses a nightly over-the-counter PM pain reliever and now has dry mouth, grogginess, and near falls.",
    summary: "Identify diphenhydramine-related sleep and safety problems and design a deprescribing-oriented plan.",
    initialSummary: "An 82-year-old woman reports poor sleep and morning grogginess. She started an over-the-counter (OTC) 'PM' pain reliever after seeing it advertised as non-habit forming.",
    difficulty: "introductory",
    estimatedMinutes: 16,
    ...
    learningObjectives: [
      { id: "pm-lo-medication", text: "Recognize anticholinergic over-the-counter (OTC) sleep aids as a modifiable cause of sleep, cognition, and fall risk." },
      { id: "pm-lo-plan", text: "Develop a nonjudgmental medication safety and deprescribing plan." },
    ],
    reasoningPathways: ["Medication-related sleep problem from diphenhydramine with anticholinergic burden", "Chronic pain-related insomnia as a contributor", "obstructive sleep apnea (OSA) or restless legs syndrome (RLS) if targeted symptoms emerge", "Multifactorial geriatric risk because cognition, constipation, nocturia, and mobility interact"],
    ...
    recommendedPriorities: ["Identify the active over-the-counter (OTC) PM ingredient and anticholinergic burden", "Assess falls, cognition, constipation, urinary retention, and pain control", "Plan deprescribing/substitution with pain-focused and behavioral sleep strategies", "Avoid adding sedative hypnotics"],
    ...
    information: [
      { id: "pm-chief", label: "Presenting Concern", category: "history", detail: "She wakes groggy and says her sleep is not refreshing despite taking an over-the-counter (OTC) PM-labeled product nightly." },
      ...
      { id: "pm-medication", label: "Over-the-Counter Ingredient", category: "medications", detail: "The over-the-counter (OTC) PM-labeled product contains acetaminophen and diphenhydramine 25 mg. She sometimes takes a second tablet." },
      ...
      { id: "pm-breathing-legs", label: "Obstructive Sleep Apnea (OSA) and Restless Legs Syndrome (RLS) Screen", category: "symptoms", detail: "No snoring, witnessed apneas, urge to move the legs, or evening rest-related leg discomfort." },
    ...
    followUp: {
      ...
      options: [
        option("pm-ask-ingredient", "Ask her to bring the over-the-counter (OTC) bottle and identify active ingredients and dose.", "Over-the-counter (OTC) PM-labeled products often contain diphenhydramine or doxylamine.", ["pm-medication"]),
        ...
        option("pm-ask-pain", "Clarify pain timing and non-sedating pain strategies.", "Pain may be the treatable driver behind over-the-counter (OTC) PM medication use.", ["pm-pain"]),
        option("pm-ask-osa-rls", "Screen briefly for obstructive sleep apnea (OSA) and restless legs syndrome (RLS) symptoms.", "Do not assume every sleep complaint is medication-related without checking common alternatives.", ["pm-breathing-legs"]),
    ...
    classification: {
      ...
      options: [
        option("pm-class-medication", "Medication-related sleep and safety problem from diphenhydramine-containing over-the-counter (OTC) PM-labeled use.", "Nightly exposure plus anticholinergic symptoms, grogginess, and near falls strongly support this pathway."),
    ...
    recommendations: {
      ...
      options: [
        option("pm-rec-stop", "Stop diphenhydramine-containing over-the-counter (OTC) PM-labeled products with a clear substitute plan.", "Deprescribing succeeds when it addresses the reason the patient started the medication."),
        ...
        option("pm-rec-education", "Explain anticholinergic effects nonjudgmentally and teach label checking for over-the-counter (OTC) PM-labeled products.", "Education reduces recurrence with similar OTC products."),
        option("pm-rec-benzo", "Replace the over-the-counter (OTC) PM product with a benzodiazepine hypnotic.", "This substitutes one high-risk sedative strategy for another."),
      ],
    },
    feedbackSummary: "This case teaches medication literacy: the active ingredient matters more than the marketing label, and sleep plans must address the symptom the over-the-counter (OTC) product was trying to solve.",
    formativeFeedback: {
      domains: [
        domain("problem-representation", "Problem Representation", ["pm-ask-ingredient", "pm-ask-anticholinergic", "pm-class-medication"], "You connected the sleep complaint to diphenhydramine and anticholinergic burden.", "Identify the over-the-counter (OTC) ingredient and symptom cluster before labeling this insomnia."),
  ...
  makeCase({
    ...
    summary: "Integrate insomnia symptoms, nocturia, medication timing, obstructive sleep apnea (OSA) risk, and fall prevention.",
    ...
    learningObjectives: [
      ...
      { id: "multi-lo-prioritize", text: "Prioritize safety, medication timing, obstructive sleep apnea (OSA) evaluation, and behavioral insomnia care." },
    ],
    reasoningPathways: ["Multifactorial geriatric sleep problem with nocturia, fall risk, medication timing, insomnia symptoms, and possible obstructive sleep apnea (OSA)", "Obstructive sleep apnea (OSA) if snoring and witnessed apneas are confirmed", "Medication-related risk from evening diuretic timing or sedating over-the-counter (OTC) products", "Chronic insomnia symptoms if prolonged sleep latency and conditioned arousal persist after contributors are addressed"],
    ...
    recommendedPriorities: ["Address immediate nighttime fall prevention and drowsy driving", "Review medications, especially diuretic timing and anticholinergic sleep aids", "Evaluate obstructive sleep apnea (OSA) risk and arrange testing when indicated", "Use behavioral insomnia strategies and nocturia management supports"],
    ...
    information: [
      ...
      { id: "multi-exam", label: "Focused Exam", category: "exam", detail: "Body mass index (BMI) is 31, blood pressure is controlled, and oxygen saturation is normal at rest." },
    ...
    followUp: {
      ...
      options: [
        ...
        option("multi-ask-medications", "Review prescription timing and over-the-counter (OTC) sleep aids.", "Evening diuretic timing and anticholinergic sleep aids can worsen nocturia, sedation, and falls.", ["multi-medications"]),
    ...
    classification: {
      ...
      options: [
        option("multi-class-mixed", "Multifactorial geriatric sleep problem with possible obstructive sleep apnea (OSA), medication contribution, nocturia, falls risk, and insomnia symptoms.", "The history contains several interacting contributors rather than one clean diagnosis."),
    ...
    redFlagStep: {
      ...
      options: [
        option("multi-flag-apneas", "Loud snoring with witnessed breathing pauses.", "This should prompt obstructive sleep apnea (OSA) assessment rather than sedative treatment."),
    ...
    recommendations: {
      ...
      options: [
        option("multi-rec-sleep-apnea", "Screen for obstructive sleep apnea (OSA) and arrange sleep testing when indicated.", "Witnessed apneas, snoring, body mass index (BMI), and sleepiness support evaluation."),
    ...
    formativeFeedback: {
      domains: [
        ...
        domain("recommendation-quality", "Recommendation Quality", ["multi-rec-sleep-apnea", "multi-rec-medication", "multi-rec-safety", "multi-rec-behavioral", "multi-rec-nocturia"], "Your recommendations match the risk profile and avoid reflexive sedative prescribing.", "Recommendations should address obstructive sleep apnea (OSA), medication risk, safety, behavioral sleep care, and nocturia."),
